...
class RecommendationAgent():
    ...
    # Function to get apriori_recommendations
    ...
    # Function to get popular product_category recommendation
    def get_popular_recommendation(self,product_categories=None,top_k=5):               
        recommendations_df = self.popular_recommendations
        
        # if product_category is a string, return a filtered list of the product_categories to get most popular
        if type(product_categories) == str:        
            product_categories = [product_categories]

        # if product_category is not empty(None)
        ...
        # a failed recommendations should return an empty list
        if recommendations_df.shape[0] == 0:
            return []

        # return the top 5 products in products_categories
        recommendations = recommendations_df['product'].tolist()[:top_k]
        return recommendations
    

    # NLP Function to classify if to use popular recommendation engine or apriori engine
    ...
    def postprocess_classfication(self, output):
        ...
        """
        try:
            output = json.loads(output)  # Safely decode the JSON
            dict_output = {
        ...
        # Function to get recommendation from order 
    ...
    # Function to take list of messages from a User and respond to it
    def get_response(self,messages):
        ...
        if recommendations == []:
            return {"role": "assistant", "content":"Sorry, I can't help with that recommendation. Can I help you with your order?"}
